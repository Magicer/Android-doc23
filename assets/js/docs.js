...
function requireLocal(file, callback) {
...
if(!isLocal){
  ...
  //local
	requireLocal(toRoot + 'jd_lists_unified.js', function(){});
	requireLocal(toRoot + 'reference/lists.js', function(){});
	requireLocal(toRoot + 'reference/gcm_lists.js', function(){});
	requireLocal(toRoot + 'reference/gms_lists.js', function(){
	// combine GCM and GMS data
	  GOOGLE_DATA = GMS_DATA;
	  var start = GOOGLE_DATA.length;
	  for (var i=0; i<GCM_DATA.length; i++) {
